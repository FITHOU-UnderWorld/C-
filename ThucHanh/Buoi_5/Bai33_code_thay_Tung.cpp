...
void prt_title()
{
    cout << setw(3) << "STT" << setw(10) << "Ten xe" << setw(10) << "Cho ngoi"
    << setw(10) << "Nam SX" << setw(10) << "Gia thue" << endl;
}

void print(Auto a, int k)
{
    cout << setw(3) << k << setw(10) << a.name << setw(10) << a.seats
    << setw(10) << a.year << setw(10) << a.cost << endl;
}
...
int main()
{
    ...
    cout << "3. Cac xe trong pham vi gia thue\n";
    cout << "4. Loai bo xe cu\n";
    cout << "5. Tang gia thue\n";
    cout << "6. Thoat\n";
