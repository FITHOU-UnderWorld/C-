...
void prt_title()
{
    cout<<setw(3)<<"STT"<<setw(6)<<"Ma "<<setw(25)<<"Ho va ten"<<setw(12)<<"Ngay sinh "<<setw(5)<<"Lop"<<setw(8)<<"So b_a"<<setw(15)<<"Tong s_t"<<endl;
}
void print(Hs x,int k)
{
    cout<<setw(3)<<k<<setw(6)<<x.ma<<setw(25)<<x.ht<<setw(12)<<x.ngs<<setw(5)<<x.lh<<setw(8)<<x.sba<<setw(15)<<x.tst<<endl;
}
void show()
{
    prt_title();
